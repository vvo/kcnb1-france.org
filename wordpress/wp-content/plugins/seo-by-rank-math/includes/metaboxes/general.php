...
$cmb->add_field( array(
	...
	'classes'     => 'nob',
	'after_field' => Helper::is_mythemeshop_connected() ? '' : '<div class="notice notice-warning inline"><p>Get keyword suggestions from Google & optimize upto 5 Focus Keywords by <a href="' . Helper::get_connect_url() . '" target="_blank">linking your Rank Math account</a>.</p></div>',
	'attributes'  => array(
