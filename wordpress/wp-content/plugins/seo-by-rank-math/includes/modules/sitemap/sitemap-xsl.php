...
<xsl:template match="/">
	...
	<div id="description">
		...
		<?php if ( false === $this->do_filter( 'sitemap/remove_credit', false ) ) : ?>
			<p>This XML Sitemap is generated by <a href="<?php echo esc_url( $url ); ?>" target="_blank">Rank Math WordPress SEO Plugin</a>. It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.</p>
		<?php endif; ?>
	...
	<div id="content">
		...
		<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
			...
			<p class="expl"><a href="<?php echo esc_url( Router::get_base_url( 'sitemap_index.xml' ) ); ?>">&#8592; Sitemap Index</a></p>
			<table id="sitemap" cellpadding="3">
				<thead>
				<tr>
					<th width="80%">URL</th>
					<?php if ( Helper::get_settings( 'sitemap.include_images' ) ) : // phpcs:ignore ?><th width="5%">Images</th><?php endif; ?>
