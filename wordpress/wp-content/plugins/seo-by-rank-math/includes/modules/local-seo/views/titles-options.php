...
$company = array( array( 'knowledgegraph_type', 'company' ) );
$person  = array( array( 'knowledgegraph_type', 'person' ) );
...
$opening_hours = $cmb->add_field( array(
	'id'      => 'opening_hours',
	'type'    => 'group',
...
$cmb->add_group_field( $opening_hours, array(
	'id'      => 'day',
	'type'    => 'select',
	'options' => array(
...
$cmb->add_group_field( $opening_hours, array(
	...
	'default'    => '09:00-17:00',
	'attributes' => array(
		'placeholder' => esc_html__( 'e.g. 09:00-17:00', 'rank-math' ),
	),
) );
...
$cmb->add_group_field( $phones, array(
	'id'      => 'type',
	'type'    => 'select',
	'options' => array(
...
$cmb->add_group_field( $phones, array(
	...
	'type'       => 'text',
	'attributes' => array(
		'placeholder' => esc_html__( 'Format: +1-401-555-1212', 'rank-math' ),
	),
) );
...
$about_options = array( '' => __( 'Select Page', 'rank-math' ) );
if ( $about_page ) {
...
$contact_options = array( '' => __( 'Select Page', 'rank-math' ) );
if ( $contact_page ) {
