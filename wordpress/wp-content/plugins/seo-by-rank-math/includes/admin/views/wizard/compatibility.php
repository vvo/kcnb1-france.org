		...
		<table class="form-table wizard-conflicts">
			<?php foreach ( $conflicting_plugins as $pk => $plugin ) { ?>
				<tr>
					...
					<td><?php echo $plugin . ( in_array( $pk, array( 'all-in-one-schemaorg-rich-snippets/index.php', 'wordpress-seo/wp-seo.php', 'wordpress-seo-premium/wp-seo-premium.php', 'all-in-one-seo-pack/all_in_one_seo_pack.php' ) ) ? '<span class="import-info">' . esc_html__( 'You can import settings in the next step.', 'rank-math' ) . '</span>' : '' ); ?></td>
