				...
				<ul class="rank-math-list-icon">
					...
					<li>
						...
						<div>
							...
							<p><a href="<?php echo KB::get( 'how-to-setup' ); ?>" target="_blank"><?php esc_html_e( 'How to Properly Setup Rank Math', 'rank-math' ); ?></a></p>
						</div>
					</li>
					...
					<li>
						...
						<div>
							...
							<p><a href="<?php echo KB::get( 'seo-import' ); ?>" target="_blank"><?php esc_html_e( 'How to Import Data from Your Previous SEO Plugin', 'rank-math' ); ?></a></p>
						</div>
					</li>
					...
					<li>
						...
						<div>
							...
							<p><a href="<?php echo KB::get( 'score-100' ); ?>" target="_blank"><?php esc_html_e( 'How to Make Your Posts Pass All the Tests', 'rank-math' ); ?></a></p>
						</div>
					</li>

				</ul>

				<a class="button button-primary button-xlarge" href="<?php echo KB::get( 'rm-kb' ); ?>" target="_blank"><?php esc_html_e( 'Visit Knowledge Base', 'rank-math' ); ?></a>
				...
				<ul class="rank-math-list-icon">
					...
					<li>
						...
						<div>
							...
							<p><a href="<?php echo KB::get( 'rm-kb' ); ?>" target="_blank"><?php esc_html_e( 'Understand all the capabilities of Rank Math', 'rank-math' ); ?></a></p>
						</div>
					</li>
					...
					<li>
						...
						<div>
							...
							<p><a href="<?php echo KB::get( 'rm-support' ); ?>" target="_blank"><?php esc_html_e( 'Direct help from our qualified support team', 'rank-math' ); ?></a></p>
						</div>
					</li>

				</ul>

				<a class="button button-primary button-xlarge" href="<?php echo KB::get( 'rm-support' ); ?>" target="_blank"><?php esc_html_e( 'Visit Support Center', 'rank-math' ); ?></a>
