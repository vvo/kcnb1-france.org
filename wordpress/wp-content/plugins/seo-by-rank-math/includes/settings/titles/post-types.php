...
if ( 'product' === $post_type || 'download' === $post_type ) {
	...
	$cmb->add_field( array(
		...
		'dep'             => array( array( 'pt_' . $post_type . '_default_rich_snippet', 'off', '!=' ) ),
	...
	$cmb->add_field( array(
		...
		'classes'         => 'rank-math-supports-variables',
		'dep'             => array( array( 'pt_' . $post_type . '_default_rich_snippet', 'off,book,local', '!=' ) ),
		'sanitization_cb' => false,
		'default'         => '%excerpt%',
	) );
}
...
// Article fields.
$article_dep = array( array( 'pt_' . $post_type . '_default_rich_snippet', 'article' ) );
...
$cmb->add_field( array(
	...
	'default' => 'titles',
	'dep'     => array( array( 'pt_' . $post_type . '_link_suggestions', 'on' ) ),
) );
...
if ( 'attachment' === $post_type ) {
	...
	$cmb->add_field( array(
		...
		'default' => 'editing',
		'dep'     => array( array( 'pt_' . $post_type . '_add_meta_box', 'on' ) ),
	) );
}
