...
$cmb->add_field( array(
	'id'   => 'social_url_gplus',
	'type' => 'text',
	'name' => esc_html__( 'Google+ Page URL', 'rank-math' ),
	'desc' => wp_kses_post( __( 'Enter Your Google+ Page URL here. eg:', 'rank-math' ) ) .
		'<br><code>' . htmlspecialchars( 'https://plus.google.com/+MyThemeShop' ) . '</code>',
) );
